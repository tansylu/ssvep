...
for layer in range(10, 20):
    sim_file = f"comparison_results/layer_pruning/models_vs_similarity_layer{layer}_2/comparison_summary.csv"
    rand_file = f"comparison_results/layer_pruning/models_vs_random_layer{layer}_2/comparison_summary.csv"
